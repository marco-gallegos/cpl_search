...
APP_CONFIG = {
    ...
    "APIKEY": os.getenv("APIKEY") if os.getenv("APIKEY") else None,
    "TIMESTAMP": os.getenv("TIMESTAMP") if os.getenv("TIMESTAMP") else None,
    "HASH": os.getenv("HASH") if os.getenv("HASH") else None,
}